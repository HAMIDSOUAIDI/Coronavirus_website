...
am4core.ready(function () {
    ...
    am4core.ready(function () {
        ...
        absolutePerCapitaSwitch.leftLabel.fill = am4core.color("#FF5733");
        absolutePerCapitaSwitch.rightLabel.fill = am4core.color("#FF5733");
        ...
        countryName.fill = am4core.color("#FF5733");
        ...
        slider.opacity = 0.7;
        slider.background.fill = am4core.color("#FF5733");
        ...
        slider.startGrip.icon.stroke = am4core.color("#FF5733");
        ...
        sizeSlider.background.fill = am4core.color("#FF5733");
        ...
        sizeLabel.fill = am4core.color("#FF5733");
...
function heh() {
    ...
    if (counts.indexOf(searc) > -1) {
      ...
      //  check.innerText = " status of corona varus in";
        ...
        check.innerText = "this country is not exist try to correct the name"
        coun.innerText = ""
        document.getElementById("cases").innerHTML = "0";
        document.getElementById("tcases").innerHTML = "0";
        document.getElementById("tdeaths").innerHTML = "0";
        document.getElementById("deaths").innerHTML = "0";
        document.getElementById("trecovered").innerHTML = "0";
